...
class ForSaleViewController: UIViewController, UIPickerViewDataSource, UITextFieldDelegate, UIPickerViewDelegate {
    ...
    @IBAction func priceMaxSlider(_ sender: UISlider) {
        
        let step: Float = 1000000
    ...
    @IBAction func priceRoomSlider(_ sender: UISlider) {
    ...
    @IBAction func priceMaxSize(_ sender: UISlider) {
